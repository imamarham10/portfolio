      ...
      <div className="wrapper">
        <motion.div className="textContainer" variants={textVariant} initial="initial" animate="animate">
          ...
          <motion.div className="buttons" variants={textVariant}>
            <motion.button variants={textVariant}>See my work</motion.button>
            <motion.button variants={textVariant}>Contact</motion.button>
          </motion.div>
          <motion.img src="/scroll.png" alt="scroll down" variants={textVariant} animate="scrollButton" />
        </motion.div>
      </div>
      <motion.div className="slidingTextContainer" variants={slidingVariant} initial="initial" animate="animate">
